---
title: "Announcing EndlessClient"
description: "Reinventing the client model."
publishDate: "Jul 04 2025"
coverImage: "/media/blog/endlessclient-announcement/endlessclient-announcement.jpg"
---
### EndlessClient is a "client" unlike any other.
...
### EndlessClient cuts out the middleman:
...
- **Powered by EndlessUI,** an incredibly optimized UI framework for Minecraft

## Launching Minecraft

Launch Minecraft directly from the app. EndlessClient will **automatically update yours mods,** so you don't have to worry about anything.
![EndlessClient launching Minecraft](/media/blog/endlessclient-announcement/launch.jpg)

## The mod menu
EndlessClient comes with a mod menu that works with all your mods. **Any mod you install from EndlessClient, Modrinth, CurseForge,
...
![EndlessConfig mod menu](/media/blog/endlessclient-announcement/endlessconfig.jpg)

**Did we mention it also works with HUDs?** You can easily configure your HUDs from the same menu.

![EndlessConfig HUD editor](/media/blog/endlessclient-announcement/hud-editor.jpg)

We call it **EndlessConfig**: a unified mod menu for all your config and HUD needs. Isn't it neat?

It's powered by EndlessUI, our incredibly optimized and customizable UI framework for Minecraft which allows us to create
...
![EndlessConfig Light Theme](/media/blog/endlessclient-announcement/light-theme-lmao.png)
![EndlessConfig Minecraft Theme](/media/blog/endlessclient-announcement/mc-theme.png)

The EndlessClient launcher is also planned to have a theming system after the initial release.

### Native EndlessConfig HUDs

If a mod supports native EndlessConfig HUDs, you can either use a typical Minecraft-themed HUD or **a modern-styled HUD design.**

![EndlessConfig HUD Designer](/media/blog/endlessclient-announcement/hud-designer.jpg)

With the help of EndlessUI, these HUDs also support **advanced "designer" features,** such as custom fonts, colors, and more.

You can even change the padding and alignment of the inner HUD elements!

## The setup

**Setting up EndlessClient is as easy as downloading the app,** selecting your favorite mod categories, and clicking "Install."

![EndlessClient setup](/media/blog/endlessclient-announcement/onboarding1.jpg)

You can also customize your mod selection.

![EndlessClient onboarding setup](/media/blog/endlessclient-announcement/onboarding2.jpg)
...
With over **4 years of experience,** we've hand-picked the best mods to include in EndlessClient.

EndlessClient can do **anything a client can do:**
...
You can install **any mod** from Modrinth, CurseForge, or even manually, and it will work seamlessly with EndlessClient.
...
- **Custom item positions** and sizes, with the **only 1.7 animations mod that's 1:1 with 1.7** for 1.8.9 and 1.21.X
- **Chat tabs,** chat copy (with screenshot support), and chat heads
- **Stop crashes from closing your game** when something goes wrong

![Chatting](/media/blog/endlessclient-announcement/chatting.png)

## When can I use EndlessClient?

Join our [Discord server](/discord) to stay updated on the progress of EndlessClient. If you are a developer, **please consider
contributing** to the project. We are a community-driven project fighting against huge corporations, and we need your help
to make EndlessClient a reality.
...
**EndlessClient is something never before seen in the Minecraft modding community.** We have spent 4 years debating and creating
